...
<qgis labelsEnabled="1" layerType="Vector" styleCategories="Symbology|Labeling" version="3.99.0-Master">
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{f6f5ca67-b993-49fe-ab04-a3b1adf6fdd9}">
      <rule key="{5acba2bd-6ae6-4d18-8f6f-f72056bd52c9}" label="Response Stations" symbol="0"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{fe239373-52a9-429e-ac27-256ef3a891c5}" locked="0" pass="0">
          <Option type="Map">
  ...
  <labeling type="rule-based">
    <rules key="{894c4400-15da-4a67-81e0-421cb0872c7c}">
      <rule key="{849a8d3e-fae5-4232-bc4b-777c42b2ea4e}">
